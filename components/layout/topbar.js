        ...
        <div ref={containerElement} className="layout-topbar">
            <div className="layout-topbar-inner">
                    ...
                    <Link href="/" legacyBehavior>
                        ...
                        <a className="layout-topbar-logo" aria-label="PrimeReact logo">
                            <svg width="146" height="35" viewBox="0 0 146 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M22.0969 18.6465L20.3461 18.2616L21.7078 20.1862V26.1522L26.0214 22.3031L26.3764 15.7598L24.2367 16.5296L22.0969 18.6465Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M11.2035 18.6465L12.9543 18.2616L11.5926 20.1862V26.1522L7.27906 22.3031L6.92397 15.7598L9.06376 16.5296L11.2035 18.6465Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    ...
                                    className="fill-primary-500 dark:fill-primary-400"
                                />
                                <path d="M21.7079 29.8089L24.2367 27.3071V24.8052L21.7079 26.9221V29.8089Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M11.5927 29.8089L9.06387 27.3071V24.8052L11.5927 26.9221V29.8089Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    ...
                                    className="fill-primary-500 dark:fill-primary-400"
                                />
                                <path d="M15.0942 18.0694L6.7296 14.9901L5.56244 10.1788L12.7599 10.7562L15.2887 18.0694H15.0942Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M18.4011 18.0694L26.7658 14.9901L27.9329 10.1788L20.5409 10.7562L18.2066 18.0694H18.4011Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M21.1245 10.1789L24.8545 9.794L22.4862 7.09967H19.7628L21.1245 10.1789Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M12.1762 10.1789L8.4462 9.794L10.8145 7.09967H13.5378L12.1762 10.1789Z" className="fill-primary-500 dark:fill-primary-400" />
                            </svg>
                        </a>
                    </Link>
                    <Link href="/" aria-label="PrimeReact logo" legacyBehavior>
                        ...
                        <a className="layout-topbar-icon">
                            <svg width="32" height="35" viewBox="0 0 32 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M21.8341 18.6465L20.0833 18.2616L21.445 20.1862V26.1522L25.7586 22.3031L26.1137 15.7598L23.9739 16.5296L21.8341 18.6465Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M10.9407 18.6465L12.6914 18.2616L11.3298 20.1862V26.1522L7.01621 22.3031L6.66113 15.7598L8.80091 16.5296L10.9407 18.6465Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    ...
                                    className="fill-primary-500 dark:fill-primary-400"
                                />
                                <path d="M21.4451 29.8089L23.9739 27.3071V24.8052L21.4451 26.9221V29.8089Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M11.3299 29.8089L8.80102 27.3071V24.8052L11.3299 26.9221V29.8089Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    ...
                                    className="fill-primary-500 dark:fill-primary-400"
                                />
                                <path d="M14.8314 18.0694L6.46675 14.9901L5.29959 10.1788L12.4971 10.7562L15.0259 18.0694H14.8314Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M18.1383 18.0694L26.5029 14.9901L27.6701 10.1788L20.2781 10.7562L17.9438 18.0694H18.1383Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M20.8617 10.1789L24.5916 9.794L22.2233 7.09967H19.5L20.8617 10.1789Z" className="fill-primary-500 dark:fill-primary-400" />
                                <path d="M11.9134 10.1789L8.18341 9.794L10.5517 7.09967H13.2751L11.9134 10.1789Z" className="fill-primary-500 dark:fill-primary-400" />
                            </svg>
                        </a>
                    </Link>
                </div>
                ...
                <ul className="flex list-none m-0 p-0 gap-2 items-center">
                    <li>
                        <a href="https://github.com/primefaces/primereact" target="_blank" rel="noopener noreferrer" className="topbar-item">
