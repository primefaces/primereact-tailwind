    ...
    root: ({
        ...
        className:
            ...
            classNames(
                ...
                'shadow-sm',
                { 'ring-1 ring-inset ring-surface-300 dark:ring-surface-700 ring-offset-0': parent?.state['__TYPE'] !== 'InputGroup' },
                ...
                { 'border-0 border-y border-l last:border-r border-surface-300 dark:border-surface-600': parent?.state['__TYPE'] == 'InputGroup' },
